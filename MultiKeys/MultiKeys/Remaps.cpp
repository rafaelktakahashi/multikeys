...
//	std::unordered_map<DWORD, IKeystrokeCommand*> layout;
//
//
//
...
//	VOID insertPair(DWORD prefixedScancode, IKeystrokeCommand* command)
//	{
//		layout.insert(std::pair<DWORD, IKeystrokeCommand*>
//			(prefixedScancode, command));
//	}
//
//	VOID insertPair(WORD scancode, IKeystrokeCommand* command)
//	{
//		layout.insert(std::pair<DWORD, IKeystrokeCommand*>
//			(scancode, command));
//	}
//
//	VOID insertPair(WORD scancodePrefix, WORD scancode, IKeystrokeCommand* command)
//	{
//		layout.insert(std::pair<DWORD, IKeystrokeCommand*>
...
//
//	IKeystrokeCommand * noAction;	// initialize in constructor - corresponds to no action
...
//
//	// Constructor
//	KEYBOARD() : noAction(new EmptyCommand()), modifierState(0), activeLevel(nullptr), activeDeadKey(nullptr)
//	{
//		for (int i = 0; i < 8; i++)
...
//	// OUT IKeystrokeCommand**const out_action - pointer to an IKeystrokeCommand*; if this function
...
//		OUT IKeystrokeCommand**const out_action)
//	{
...
//		IKeystrokeCommand* remappedCommand;
//
//		if (activeLevel != nullptr)
//		{
...
//				{
//					activeDeadKey = (DeadKeyCommand*)remappedCommand;
//					*out_action = noAction;
//					return TRUE;
//				}
//		}
...
//
//
//BOOL Multikeys::Remapper::EvaluateKey(RAWKEYBOARD* keypressed, WCHAR* deviceName, IKeystrokeCommand ** out_action)
//{
//	
...
//}
//
//static BOOL Multikeys::SendKeyUp(WORD vKeyCode)
//{
